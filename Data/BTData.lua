...
BTLocale = {
    enUS = {
        ...
        hideTooltip = {
            label = "Hide Tooltip",
            tooltip = "Hide the tooltip while in combar"
        },
        toggleAnchor = {
            label = "Tooltip Anchor",
            tooltip = "Anchor tooltips to the cursor and change the position"
        },
        anchorPosition = {
            label = "",
            tooltip = ""
        ...
        toggleScaling = {
            ...
            tooltip = "Activate scaling for all tooltips"
        },
        tooltipScale = {
            label = "Tooltip Scale",
            tooltip = "Min: 5% Max 250%"
        }
    }
}
